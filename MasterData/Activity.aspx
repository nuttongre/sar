...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function AddItem() {
            ...
            location.href = "Activity.aspx?mode=1&ckMg=" + ckMg;
        }
        function EditItem(id) {
            var ckMg = $get("<%=cbNotManager.ClientID%>").checked;
            location.href = "Activity.aspx?mode=2&id=" + id + "&ckMg=" + ckMg;
        }
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "Activity.aspx?mode=3&id=" + id;
        }
        ...
        function printRpt(mode, type, id, ckOld) {
            ...
            var ckMg = $get("<%=cbNotManager.ClientID%>").checked;
            window.open("../GtReport/Viewer.aspx?rpt=" + mode + "&id=" + id + "&rpttype=" + type + "&ckSign=" + ckSing + "&ckOld=" + ckOld + "&ckLogo=" + ckLogo + "&ckMg=" + ckMg);
        }
        ...
        function ckBudgetTerm() {
            ...
            if (hdfBudgetTerm == 1) {
                ...
                if (BudgetTotal != (BudgetTotalTerm1 + BudgetTotalTerm2)) {
                    $get("spnErrorBudgetTerm").innerHTML = "ยอดงบประมาณรวม 2 ภาคเรียนไม่เท่ากับยอดรวมทั้งหมดที่ " + BudgetTotal.comma();
    ...
    function OnCopy(id) {
        ...
        function PopUpUplodeFile(id) {
            dialogBox.show('../PopUp/PopUpUploadFile.aspx?id=' + id, 'แนบไฟล์', '1000', '400', '#000', true, 'yes');
        }
        ...
        function getActivityName() {
            var ActivityName = $get("<%=txtActivity.ClientID%>").value;
            $get("spnActivityName").innerHTML = ActivityName;
        }
        function ckUpload() {
        ...
        function isANumber(object) {
            console.log(object.value);
            //return;
            return !/^[ก-๙]+$/ig.test(object.value) //true
        }
    </script>
                    ...
                    <ContentTemplate>
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                ...
                                <div class="inputrow">
                                    <div class="SearchtxtF">
                                        <span class="spantxt">ประเภทกิจกรรม : </span>
                                    </div>
                                    <div class="SearchF">
                                ...
                                <div class="inputrow">
                                    ...
                                    <div class="SearchF">
                                        <asp:DropDownList ID="ddlSearchSubDept" CssClass="ddlSearch" runat="server" AutoPostBack="true"
                                            OnSelectedIndexChanged="ddlSearchSubDept_SelectedIndexChanged" Width="500px">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="inputrow">
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true" PageSize="20">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="เชื่อมโยง" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                    ...
                                    <Control:TemplateField HeaderText="แบบเก่า">
                                        <ItemTemplate>
                                            <%# checkapprove(Eval("ActivityCode").ToString(), 1)%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="7%" />
                                        <FooterStyle HorizontalAlign="Right" Font-Bold="true" Font-Size="13pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="แบบที่3">
                                        <ItemTemplate>
                                            <%# checkapprove(Eval("ActivityCode").ToString(), 2)%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="7%" />
                                        <FooterStyle HorizontalAlign="Right" Font-Bold="true" Font-Size="13pt"
                                            BackColor="#cecece" BorderStyle="Solid" BorderColor="gray" BorderWidth="2" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="ไฟล์">
                                        <ItemTemplate>
                ...
                <div id="table1" class="PageManageDiv">
                        ...
                        <ContentTemplate>
                            <div class="inputrowH" style="display: none;">
                                ...
                                <div class="divB_Head">
                                    <asp:RadioButtonList ID="rbtlYearType" runat="server" Enabled="false" AutoPostBack="true" RepeatColumns="2" OnSelectedIndexChanged="rbtlYearType_SelectedIndexChanged">
                                        <asp:ListItem Text=" ปีการศึกษา" Value="0" Selected="True"></asp:ListItem>
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    ...
                                    <asp:HiddenField ID="hdfNotManager" runat="server" />
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    ...
                                    <asp:TextBox CssClass="txtBoxL" ID="txtActivity" runat="server" onblur="getActivityName();" Width="600px" MaxLength="200"></asp:TextBox>
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtEmp" CssClass="txtReadOnly" onkeypress="return false" runat="server" onpaste="alert('กรุณาเลือกผู้รับผิดชอบ'); return false;"
                                        Width="600" />
                                    <span class="ColorRed">*</span>&nbsp;
                                <img src="../image/adduseradmin.png" style="cursor: pointer; width: 32px; height: 32px; border: none; vertical-align: bottom;" title="คลิ๊กเพื่อเลือกผู้รับผิดชอบ"
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtDepartment" CssClass="txtReadOnly" onkeypress="return false" onpaste="alert('กรุณาเลือกผู้รับผิดชอบ'); return false;"
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtSubDept" CssClass="txtReadOnly" onkeypress="return false" runat="server" onpaste="alert('กรุณาเลือกหน่วยงานย่อย'); return false;"
                                        Width="600" />&nbsp;&nbsp;
                            <img src="../image/dept.png" style="cursor: pointer; width: 32px; height: 32px; border: none; vertical-align: bottom;" title="คลิ๊กเพื่อเลือกหน่วยงานย่อย"
                                onclick="return ckSubDept();" />
                                    <asp:HiddenField ID="SubDeptid" runat="server" />
                                </div>
                            </div>
                            <div class="spaceDiv"></div>
                            <div id="divSuan" class="TableSearch" runat="server">
                                <div class="SearchTable">
                                    <div class="SearchHead">
                                        <span class="spantxt2 spansize14">แผนกลยุทธ์การพัฒนาโรงเรียน</span>
                                    </div>
                                    <div class="spaceDiv"></div>
                                    <div class="inputrow" style="height: auto;">
                                        <div class="SearchtxtF">
                                            <span class="spantxt">กลยุทธ์ (Strategies) : </span>
                                        </div>
                                        <div class="SearchF" style="height: auto">
                                            <asp:Label ID="lblStrategies" runat="server" Text=""></asp:Label>
                                        </div>
                                    </div>
                                    <div class="spaceDiv"></div>
                                    <div class="inputrow" style="height: auto;">
                                    ...
                                    <div class="spaceDiv"></div>
                                    <div class="SearchHead">
                                        <span class="spantxt2 spansize14">SUAN Model</span>
                                    </div>
                                    <div class="spaceDiv"></div>
                                    <div class="inputrow" style="height: auto">
                                        <div class="SearchtxtF">
                                            <span class="spantxt">S สอดคล้องกับเอกลักษณ์ด้าน : </span>
                                        </div>
                                        <div class="SearchF" style="height: auto">
                                            <div style="float: left; width: 170px;">
                                                <asp:RadioButtonList ID="rbtlSuanIdentityName" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rbtlSuanIdentityName_SelectedIndexChanged"></asp:RadioButtonList>
                                            </div>
                                            <div style="float: left; width: 300px;">
                                                <div style="float: left; width: 45px;"><span class="spantxt">ด้าน : </span></div>
                                                <asp:CheckBoxList ID="cblSuanIdentitySideName" runat="server" RepeatColumns="4">
                                                </asp:CheckBoxList>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="inputrow">
                                        <div class="SearchtxtF">
                                            <span class="spantxt">U สอดคล้องกับอัตลักษณ์ด้าน : </span>
                                        </div>
                                        <div class="SearchF" style="height: auto">
                                            <asp:CheckBoxList ID="cblSuanIdentityName2" runat="server" RepeatColumns="6">
                                            </asp:CheckBoxList>
                                        </div>
                                    </div>
                                    <div class="inputrow">
                                        <div class="SearchtxtF">
                                            <span class="spantxt" style="font-size: 13px;">A กิจกรรมที่ดำเนินการตามระบบ PDCA : </span>
                                        </div>
                                        <div class="SearchF">
                                            <span id="spnActivityName"></span>
                                        </div>
                                    </div>
                                    <div class="inputrow">
                                        <div class="SearchtxtF">
                                            <span class="spantxt">N เป็นกิจกรรมที่ส่งผลดีต่อ : </span>
                                        </div>
                                        <div class="SearchF">
                                            <asp:CheckBoxList ID="cblSuanGood" runat="server" RepeatColumns="5">
                                            </asp:CheckBoxList>
                                        </div>
                                    </div>
                                    <div class="spaceDiv"></div>
                            ...
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ผู้เข้าร่วมกิจกรรม : </span>
                                </div>
                                <div class="divB_Head">
                                        ...
                                        <table width="100%" style="border: solid 1px gray;" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="cutbudget3" style="width: 40%; border-top: none; border-bottom: none;">
                                                    ...
                                                    <span class="spantxt">งบดำเนินงาน (งบอุดหนุน) : </span>
                                                    ...
                                                    <span class="spantxt">(งบอื่นๆ) : </span>
                                                ...
                                                <td style="width: 40%; border: solid 1px Gray; border-top: none; border-bottom: none; text-align: center;">
                                                    <Control:DataGridView ID="GridViewOperation2" runat="server" AutoGenerateCheckList="true"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <Control:TemplateField HeaderText="งบอื่นๆ">
                                                                <ItemTemplate>
                            ...
                            <div id="divRisk" class="inputrowH" runat="server" visible="false">
                                <div class="divF_Head">
                                    <span class="spantxt">ความเสี่ยงในกิจกรรม :</span>
                                </div>
                                <div class="divB_Head">
                                    <div class="inputrowH">
                                        <div class="divF_Head" style="width: 15%;">
                                            <span class="spantxtSmall">ความเสี่ยง :</span>
                                        </div>
                                        <div class="divB_Head">
                                            <asp:TextBox CssClass="txtBoxL" ID="txtRisk" runat="server" Width="450px" TextMode="MultiLine"
                                                Height="100px"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="inputrowH">
                                        <div class="divF_Head" style="width: 15%;">
                                            <span class="spantxtSmall">แนวทางป้องกัน :</span>
                                        </div>
                                        <div class="divB_Head">
                                            <asp:TextBox CssClass="txtBoxL" ID="txtProtect" runat="server" Width="450px"
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    ...
                                    <div id="divAcAssessmentOld" runat="server">
                                        <div class="inputrowH" id="divSuanProduct" runat="server">
                                            <div class="divF_Head" style="width: 15%;">
                                                <span class="spantxtSmall">ตัวชี้วัดความสำเร็จ (ผลผลิต) :</span>
                                            </div>
                                            <div class="divB_Head">
                                                <asp:TextBox CssClass="txtBoxL" ID="txtEvaIndicatorsProduct" runat="server" Width="450px"
                                                    TextMode="MultiLine" Height="100px"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="inputrowH">
                                            <div class="divF_Head" style="width: 15%;">
                                                <span class="spantxtSmall">ตัวชี้วัดความสำเร็จ (ผลลัพธ์) :</span>
                                            </div>
                                            <div class="divB_Head">
                                        ...
                                        <div class="inputrowH" id="divSuanTime" runat="server">
                                            <div class="divF_Head" style="width: 15%;">
                                                <span class="spantxtSmall">ระยะเวลาที่ประเมิน :</span>
                                            </div>
                                            <div class="divB_Head">
                                                <asp:TextBox CssClass="txtBoxL" ID="txtEvaTime" runat="server" Width="450px" MaxLength="100"
                                                ></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="divB_Head">
                                        ...
                                        <Control:DataGridView ID="GridViewAssessment" runat="server" AutoGenerateCheckList="true"
                                            ...
                                            <Columns>
                                                ...
                                                <Control:TemplateField HeaderText="แก้ไข">
                                                    <ItemTemplate>
                                                        <img src="../Image/edit.gif" style="cursor: pointer;" onclick="editmodeAssessment('<%#Container.DataItemIndex %>');" title="เลือกเพื่อแก้ไข" alt="เลือกเพื่อแก้ไข" />
                                                    </ItemTemplate>
                                                    <ItemStyle HorizontalAlign="Center" Width="5%" />
                                                </Control:TemplateField>
                                            </Columns>
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:Label ID="lblAlertApprove" runat="server" ForeColor="Red" Text="*** กิจกรรมนี้ได้ถูกอนุมัติแล้ว  ถ้าต้องการแก้ไขวันที่ดำเนินการหรือแก้ไขงบประมาณ  กรุณาติดต่อฝ่ายแผนงาน"
                                        Visible="false"></asp:Label>
                                    <asp:ImageButton ID="ImgBtUnApprove" ToolTip="กู้คืนการอนุมัติ" ImageUrl="../Image/reset.gif" OnClick="ImgBtUnApprove_Click" runat="server" Visible="false" />
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                    ...
                    <div id="Div2" class="TableSearch">
                        <div class="SearchTable" style="width: 90%; height: auto;">
                            ...
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">Download แบบฟอร์ม : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                                        <ContentTemplate>
                                            <a id="spnDownLoadFile" runat="server" title="Download แบบฟอร์ม" href="../Doc/ImportBudget.xls">
                            ...
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">นำเข้ารายการค่าใช้จ่าย : </span>
                                </div>
                                <div class="divB_Head">
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="inputrowH">
                                        ...
                                        <div class="divB_Head">
                                            ...
                                            <a href="javascript:;" onclick="BudgetClear();">ล้างรายการ</a>
                                        </div>
                                    </div>
                                    <div class="inputrowH">
                                        <div class="divF_Head">
                                        ...
                                        <div class="divB_Head">
                                            ...
                                            <div style="float: left; padding: 0px 10px;">
                                                ...
                                                <br />
                                                <span style="font-size: 13px;">(สรรพนาม)</span>
                                            </div>
                                            <div style="float: left;">
                                    ...
                                    <div class="inputrowH">
                                        <div class="divF_Head">
                                            <span id="spnBudgetTerm" class="spantxt" runat="server">งบภาคเรียนที่ 1 : </span>
                                        ...
                                        <div class="divB_Head">
                                            <div id="divBudgetTerm" style="float: left;" runat="server">
                                                ...
                                                <div style="float: left; padding: 0px 10px;">
                                                    <span class="spantxt">งบภาคเรียนที่ 2 : </span>
                                        ...
                                        <Control:DataGridView ID="GridViewBudget" runat="server" AutoGenerateCheckList="true"
                                            ...
                                            <Columns>
                                                ...
                                                <Control:TemplateField HeaderText="รายการ">
                                                    <ItemTemplate>
                                                        <a style="cursor: pointer;" title="ใช้รายการนี้อีกครั้ง" onclick="OnCopy('<%#Container.DataItemIndex %>');"><span id="spnListName<%#Container.DataItemIndex %>">
                                                ...
                                                <Control:TemplateField HeaderText="เทอม 1">
                                                    <ItemTemplate>
                                                ...
                                                <Control:TemplateField HeaderText="เทอม 2">
                                                    <ItemTemplate>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            ...
                            <div id="Div3" class="TableSearch">
                                ...
                                <div class="inputrowH">
                                    ...
                                    <div class="divB_Head">
                                        ...
                                        <div style="float: left; padding-left: 5px;">
                                            ...
                                            <asp:TextBox CssClass="txtBoxL" ID="txtResponsiblePosition2" runat="server" Width="270px"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrowH">
                                    <div class="divF_Head">
                                        <asp:TextBox ID="txtKeyWordProposeActivity" Width="250px" MaxLength="100" CssClass="txtBoxlblnone" runat="server" AutoPostBack="true" OnTextChanged="txtKeyWordProposeActivity_TextChanged"></asp:TextBox>
                                        <span class="spantxt">: </span>
                                    </div>
                                    <div class="divB_Head">
                                        ...
                                        <span class="ColorRed">*</span> <span id="ErrorPropose" class="ErrorMsg">กรุณาป้อนข้อมูลผู้เสนอกิจกรรม</span>
                                    </div>
                                </div>
                                <div class="inputrowH">
                                    <div class="divF_Head">
                                        <asp:TextBox ID="txtKeyWordApprovalActivity" Width="250px" MaxLength="100" CssClass="txtBoxlblnone" runat="server" AutoPostBack="true" OnTextChanged="txtKeyWordApprovalActivity_TextChanged"></asp:TextBox>
                                        <span class="spantxt">: </span>
                                    </div>
                                    <div class="divB_Head">
                                        ...
                                        <span id="starApprovelName" class="ColorRed">*</span> <span id="ErrorApproval" class="ErrorMsg">กรุณาป้อนข้อมูลผู้เห็นชอบกิจกรรม</span>
                                    </div>
                                </div>
                                <div class="inputrowH">
                                    <div class="divF_Head">
                                        <asp:TextBox ID="txtKeyWordApproval2Activity" Width="250px" MaxLength="100" CssClass="txtBoxlblnone" runat="server" AutoPostBack="true" OnTextChanged="txtKeyWordApproval2Activity_TextChanged"></asp:TextBox>
                                        <span class="spantxt">: </span>
                                    </div>
                                    <div class="divB_Head">
                                ...
                                <div class="centerDiv">
                                    ...
                                    <asp:Label ID="lblResponsiblePosition" runat="server" CssClass="spantxt4" Text="ตำแหน่ง : " Visible="false"></asp:Label>
                                    <asp:TextBox ID="txtResponsiblePosition" CssClass="txtBoxL" runat="server" Visible="false"></asp:TextBox>
                                </div>
                                <div class="centerDiv">
                                    <asp:Button ID="btnEditCreate" runat="server" Text="บันทึก" Visible="false" OnClick="btnEditCreate_Click" /><asp:Button ID="btnCancelCreate" runat="server" Text="ยกเลิก" Visible="false" OnClick="btnCancelCreate_Click" />
                                </div>
                                <div class="spaceDiv"></div>
                                ...
                                <div class="centerDiv">
                                    <div class="classButton">
                                        ...
                                        <div class="classBtCancel">
                                            <input type="button" class="btNo" value="      ไม่บันทึก" title="ไม่บันทึกกิจกรรมนี้" onclick="Cancel();" />
                                        </div>
                                    </div>
                                </div>
                                <div class="clear"></div>
