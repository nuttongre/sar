<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="CopyEducation21.aspx.cs" Inherits="CopyEducation21" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function Cancel() {
            location.href = "CopyEducation21.aspx";
        }
    </script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    คัดลอกด้าน/มาตรฐาน/ตัวชี้วัด ศต.21
                </div>
                                ...
                                <div class="centerDiv">
                                    <div class="classButton">
                                        ...
                                        <div class="classBtCancel">
                                            <input type="button" class="btNo" value="      ไม่คัดลอก" title="ไม่คัดลอกด้าน/มาตรฐาน/ตัวชี้วัด" onclick="Cancel();" />
                                        </div>
                                    </div>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:BoundField HeaderText="ตัวชี้วัด" DataField="IndicatorsC">
                                        <ItemStyle Width="30%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                </Columns>
