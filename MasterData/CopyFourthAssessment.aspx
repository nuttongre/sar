<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="CopyFourthAssessment.aspx.cs" Inherits="CopyFourthAssessment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function Cancel() {
            location.href = "CopyFourthAssessment.aspx";
        }
    </script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    คัดลอกด้าน/ตัวบ่งชี้การประเมินภายนอกรอบ 4
                </div>
                                    ...
                                    <div class="classButton">
                                        <div class="classBtSave">
                                            <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       คัดลอก" OnClick="btSave_Click"
                                                ToolTip="คัดลอกด้าน/ตัวบ่งชี้การประเมินภายนอกรอบ 4" />
                                        </div>
                                        <div class="classBtCancel">
                                            <input type="button" class="btNo" value="      ไม่คัดลอก" title="ไม่คัดลอกด้าน/ตัวบ่งชี้การประเมินรอบ 4" onclick="Cancel();" />
                                        </div>
                                    </div>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:BoundField HeaderText="ด้านการประเมินภายนอกรอบ 4" DataField="FourthAssessmentSide">
                                        <ItemStyle Width="45%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:BoundField HeaderText="ตัวบ่งชี้การประเมินภายนอกรอบ 4" DataField="FourthAssessmentIndicator">
                                        <ItemStyle Width="45%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                </Columns>
