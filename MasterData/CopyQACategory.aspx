<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="CopyQACategory.aspx.cs" Inherits="CopyQACategory" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function Cancel() {
            location.href = "CopyQACategory.aspx";
        }
    </script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    คัดลอกหมวด/หัวข้อเกณฑ์รางวัลคุณภาพ
                </div>
                                    ...
                                    <div class="classButton">
                                        <div class="classBtSave">
                                            <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       คัดลอก" OnClick="btSave_Click"
                                                ToolTip="คัดลอกหมวด/หัวข้อเกณฑ์รางวัลคุณภาพ" />
                                        </div>
                                        <div class="classBtCancel">
                                            <input type="button" class="btNo" value="      ไม่คัดลอก" title="ไม่คัดลอกหมวด/หัวข้อเกณฑ์รางวัลคุณภาพ" onclick="Cancel();" />
                                        </div>
                                    </div>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:BoundField HeaderText="หมวดเกณฑ์รางวัลคุณภาพ" DataField="QACategory">
                                        <ItemStyle Width="45%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:BoundField HeaderText="หัวข้อเกณฑ์รางวัลคุณภาพ" DataField="QACategorySub">
                                        <ItemStyle Width="45%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                </Columns>
