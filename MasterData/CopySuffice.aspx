<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="CopySuffice.aspx.cs" Inherits="CopySuffice" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function Cancel() {
            location.href = "CopySuffice.aspx";
        }
    </script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    คัดลอกด้าน/องค์ประกอบ/ตัวบ่งชี้ปรัชญาเศรษฐกิจพอเพียง
                </div>
                                    ...
                                    <div class="classButton">
                                        <div class="classBtSave">
                                            <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       คัดลอก" OnClick="btSave_Click"
                                                ToolTip="คัดลอกด้าน/องค์ประกอบ/ตัวบ่งชี้ปรัชญาเศรษฐกิจพอเพียง" />
                                        </div>
                                        <div class="classBtCancel">
                                            <input type="button" class="btNo" value="      ไม่คัดลอก" title="ไม่คัดลอกด้าน/องค์ประกอบ/ตัวบ่งชี้ปรัชญาเศรษฐกิจพอเพียง" onclick="Cancel();" />
                                        </div>
                                    </div>
                                </div>
                                <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:BoundField HeaderText="ด้านปรัชญาเศรษฐกิจพอเพียง" DataField="SufficeSide">
                                        <ItemStyle Width="30%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:BoundField HeaderText="องค์ประกอบปรัชญาเศรษฐกิจพอเพียง" DataField="SufficeStandard">
                                        <ItemStyle Width="30%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:BoundField HeaderText="ตัวบ่งชี้ปรัชญาเศรษฐกิจพอเพียง" DataField="SufficeIndicator">
                                        <ItemStyle Width="30%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                </Columns>
