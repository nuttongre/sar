...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "FourthAssessmentIndicator.aspx?mode=3&id=" + id;
        }
        function Cancel() {
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    ตัวบ่งชี้การประเมินภายนอกรอบที่ 4
                </div>
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="view" runat="server">
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาตัวบ่งชี้การประเมินภายนอกรอบที่ 4</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                                ...
                                <div class="inputrow">
                                    <div class="SearchtxtF">
                                        <span class="spantxt">ด้านการประเมินภายนอกรอบที่ 4 : </span>
                                    </div>
                                    <div class="SearchF">
                            ...
                            <div class="spaceDiv"></div>
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" Text="       สร้างตัวบ่งชี้การประเมินภายนอกรอบที่ 4 ใหม่" OnClientClick="AddItem();"
                                    ToolTip="สร้างตัวบ่งชี้การประเมินภายนอกรอบที่ 4 ใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server" PageSize="30">
                                <Columns>
                                    <Control:BoundField HeaderText="ตัวบ่งชี้การประเมินภายนอกรอบที่ 4 ที่" DataField="Sort1">
                                        <ItemStyle Width="5%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:TemplateField HeaderText="ตัวบ่งชี้การประเมินภายนอกรอบที่ 4">
                                        <ItemTemplate>
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="table1" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ตัวบ่งชี้การประเมินภายนอกรอบที่ 4 ที่ : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtSort" CssClass="txtBoxNum txt50" Width="70px" MaxLength="2" runat="server" onkeypress="return KeyNumber(event);"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorSort" class="ErrorMsg">กรุณาป้อนตัวบ่งชี้การประเมินภายนอกรอบที่ 4ที่</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                ...
                                <div class="divB_Head">
                                    ...
                                    <span class="ColorRed">*</span> <span id="ErrorFourthAssessmentSide" class="ErrorMsg">เลือกหมวด</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ตัวบ่งชี้การประเมินภายนอกรอบที่ 4 : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtFourthAssessmentIndicator" CssClass="txtBoxL txt400" MaxLength="200" runat="server"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorFourthAssessmentIndicator" class="ErrorMsg">กรุณาป้อนตัวบ่งชี้การประเมินภายนอกรอบที่ 4</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                ...
                                <div class="classButton">
                                    <div class="classBtSave">
                                        <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก" OnClick="btSave_Click"
                                            OnClientClick="return Cktxt(1);" ToolTip="บันทึกตัวบ่งชี้การประเมินภายนอกรอบที่ 4 นี้" />
                                        <asp:Button ID="btSaveAgain" CssClass="btYesToo" runat="server" Text="       บันทึกและสร้างตัวบ่งชี้การประเมินภายนอกรอบที่ 4 ใหม่"
                                            OnClick="btSaveAgain_Click" OnClientClick="return Cktxt(1);" ToolTip="บันทึกตัวบ่งชี้การประเมินภายนอกรอบที่ 4นี้และสร้างตัวบ่งชี้การประเมินภายนอกรอบที่ 4 ใหม่" />
                                    </div>
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridView2" runat="server" Visible="false">
                                    <Columns>
                                        ...
                                        <Control:BoundField HeaderText="ตัวบ่งชี้การประเมินภายนอกรอบที่ 4" DataField="FourthAssessmentIndicatorName">
