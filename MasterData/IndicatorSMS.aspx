<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="IndicatorSMS.aspx.cs" Inherits="IndicatorSMS" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function AddItem() {
            location.href = "IndicatorSMS.aspx?mode=1";
        }
        function EditItem(id) {
            location.href = "IndicatorSMS.aspx?mode=2&id=" + id;
        }
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "IndicatorSMS.aspx?mode=3&id=" + id;
        }
        function Cancel() {
            location.href = "IndicatorSMS.aspx";
        }
        ...
        function Cktxt(m) {
            var ck = 0;
            var txtIndicatorSMS = $get("<%=txtIndicatorSMS.ClientID%>");
            var ErrorIndicatorSMS = $get("ErrorIndicatorSMS");
            var txtSort = $get("<%=txtSort.ClientID%>");
            var ErrorSort = $get("ErrorSort");

            ck += ckTxtNull(m, txtSort, ErrorSort);
            ck += ckTxtNull(m, txtIndicatorSMS, ErrorIndicatorSMS);
                        ...
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาตัวบ่งชี้ สมศ.</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างตัวบ่งชี้ สมศ.ใหม่" ToolTip="สร้างตัวบ่งชี้ สมศ.ใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="ชื่อตัวบ่งชี้ สมศ.">
                                        <ItemTemplate>
                                            <%# checkedit(Eval("IndicatorSMSCode").ToString(), Eval("IndicatorSMSName").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="80%" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="แก้ไข">
                                        <ItemTemplate>
                                            <a href="javascript:;" onclick="EditItem('<%#Eval("IndicatorSMSCode") %>');">
                                    ...
                                    <Control:TemplateField HeaderText="ลบ">
                                        <ItemTemplate>
                                            <a href="javascript:deleteItem('<%#Eval("IndicatorSMSCode") %>');">
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="table1" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtIndicatorSMS" CssClass="txtBoxL txt500" runat="server"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorIndicatorSMS" class="ErrorMsg">กรุณาป้อนตัวบ่งชี้ สมศ.</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                ...
                                <div class="classButton">
                                    <div class="classBtSave">
                                        <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก" OnClick="btSave_Click"
                                            OnClientClick="return Cktxt(0);" ToolTip="บันทึกตัวบ่งชี้ สมศ.นี้" />
                                        <asp:Button ID="btSaveAgain" CssClass="btYesToo" runat="server" Text="       บันทึกและสร้างตัวบ่งชี้ สมศ.ใหม่"
                                            OnClick="btSaveAgain_Click" OnClientClick="return Cktxt(0);" ToolTip="บันทึกตัวบ่งชี้ สมศ.นี้และสร้างตัวบ่งชี้ สมศ.ใหม่" />
                                    </div>
                                    <div class="classBtCancel">
                                        <input type="button" class="btNo" value="      ไม่บันทึก" title="ไม่บันทึกตัวบ่งชี้ สมศ.นี้" onclick="Cancel();" />
                                    </div>
                                </div>
                            </div>
                            <div class="clear"></div>
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridView2" runat="server" Visible="false">
                                    <Columns>
                                        ...
                                        <Control:BoundField HeaderText="ชื่อตัวบ่งชี้ สมศ." DataField="IndicatorSMSName">
