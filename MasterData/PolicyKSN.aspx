<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" AutoEventWireup="true"
    CodeFile="PolicyKSN.aspx.cs" Inherits="PolicyKSN" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <script type="text/javascript">
        function AddItem() {
            location.href = "PolicyKSN.aspx?mode=1";
        }
        function EditItem(id) {
            location.href = "PolicyKSN.aspx?mode=2&id=" + id;
        }
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "PolicyKSN.aspx?mode=3&id=" + id;
        }
        function Cancel() {
            location.href = "PolicyKSN.aspx";
        }
        ...
        function Cktxt(m) {
            var ck = 0;
            var txtPolicyKSN = $get("<%=txtPolicyKSN.ClientID%>");
            var ErrorPolicyKSN = $get("ErrorPolicyKSN");
            var txtSort = $get("<%=txtSort.ClientID%>");
            var ErrorSort = $get("ErrorSort");

            ck += ckTxtNull(m, txtSort, ErrorSort);
            ck += ckTxtNull(m, txtPolicyKSN, ErrorPolicyKSN);
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    การศึกษานอกระบบและการศึกษาตามอัธยาศัย (สำนักงาน กศน.)
                </div>
                        ...
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาการศึกษานอกระบบและการศึกษาตามอัธยาศัย (สำนักงาน กศน.)</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างนโยบายการศึกษานอกระบบใหม่" ToolTip="สร้างนโยบายการศึกษานอกระบบใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                            ...
                            <Control:DataGridView ID="GridView1" runat="server" PageSize="20">
                                <Columns>
                                    ...
                                    <Control:TemplateField HeaderText="ชื่อนโยบาย">
                                        <ItemTemplate>
                                            <%# checkedit(Eval("PolicyKSNID").ToString(), Eval("PolicyKSNName").ToString())%>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Left" Width="80%" />
                                    </Control:TemplateField>
                                    <Control:TemplateField HeaderText="แก้ไข">
                                        <ItemTemplate>
                                            <a href="javascript:;" onclick="EditItem('<%#Eval("PolicyKSNID") %>');">
                                    ...
                                    <Control:TemplateField HeaderText="ลบ">
                                        <ItemTemplate>
                                            <a href="javascript:deleteItem('<%#Eval("PolicyKSNID") %>');">
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="table1" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtPolicyKSN" CssClass="txtBoxL txt400" MaxLength="200" runat="server"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorPolicyKSN" class="ErrorMsg">กรุณาป้อนชื่อนโยบาย</span>
                                </div>
                            </div>
                             <div class="inputrowH">
                                <div class="divF_Head">
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridView2" runat="server" Visible="false" PageSize="20">
                                    <Columns>
                                        ...
                                        <Control:BoundField HeaderText="ชื่อนโยบาย" DataField="PolicyKSNName">
