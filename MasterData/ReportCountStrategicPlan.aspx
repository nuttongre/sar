<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" CodeFile="ReportCountStrategicPlan.aspx.cs"
    Inherits="ReportCountStrategicPlan" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function popup(id, syear) {
            dialogBox.show('../PopUp/PopUpCountProjectsByKSN.aspx?mode=P4&id=' + id + '&syear=' + syear, 'รายชื่อโครงการ', '1000', '500', '#000', true, true);
        }
    </script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div id="pageDiv">
                ...
                <div class="headTable">
                    จำนวนโครงการตามกลยุทธ์ระดับแผนงาน
                </div>
                                    ...
                                    <li class="<%#Eval("CountAc").ToString() == "0" ? "imgR" : "imgG" %>">
                                        <div style="width: 98%;">
                                            <span class="<%#Eval("CountAc").ToString() == "0" ? "spantxtCountRed" : "spantxtCountNormal" %>"
                                                title="<%#Eval("CountAc")%>" onclick="popup('<%#Eval("StrategicPlanID") %>', '<%# ddlYearB.SelectedValue %>');">
                                                <%#Eval("CountAc")%></span>
                                            <span class="spantxtStandardAct" title="<%#Eval("StrategicPlanName") %>">
                                                <%#Eval("FullStrategicPlanName") %></span>
                                            <hr />
                                            <br />
                                        </div>
                                    </li>
