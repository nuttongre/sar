...
public partial class RptBudgetProjects : System.Web.UI.Page
{
    BTC btc = new BTC();
    ...
    {
        string strSql = " Select a.ProjectsCode, a.ProjectsName FullName, a.Sort From Projects a, Activity b "
    ...
    protected void ddlSearchDept_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            rbtType1.Enabled = true;
            rbtType2.Enabled = true;
        }
        else
        {
            rbtType1.Enabled = false;
            rbtType2.Enabled = false;
        }
    }
}
