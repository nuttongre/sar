<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" CodeFile="SarView2.aspx.cs"
    Inherits="SarView2" %>
    ...
    <ajax:AjaxPanel ID="AjaxPanel1" runat="server">
        ...
        <div style="padding: 0 0 0 40px; vertical-align: bottom;">
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <a style="cursor: pointer;" onclick="GotoIndicators('<%#Eval("StandardCode")%>');">
                        <%#Eval("FullName")%></a>
                </ItemTemplate>
            </asp:Repeater>
        </div>
