<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" CodeFile="SarView3.aspx.cs"
    Inherits="SarView3" %>
    ...
    <ajax:AjaxPanel ID="AjaxPanel1" runat="server">
            ...
            <asp:Repeater ID="Repeater2" runat="server">
                <ItemTemplate>
                    <a id="spnSvHead" onclick="SarView2('<%#Eval("SideCode")%>');">
                        <%#Eval("SideName")%></a>&nbsp;|&nbsp; <span class="spnSvHeadAc">
                            <%#Eval("StandardName")%></span>&nbsp;|
                </ItemTemplate>
            </asp:Repeater>
        </div>
        <br />
        ...
        <div style="padding: 0 0 0 40px; vertical-align: bottom;">
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <a style="cursor: pointer;" onclick="GotoProjects('<%#Eval("IndicatorsCode")%>');">
                        <%#Eval("FullName")%></a>
                </ItemTemplate>
            </asp:Repeater>
        </div>
