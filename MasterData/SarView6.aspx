<%@ Page Language="C#" MasterPageFile="~/Master/MasterOriginal.master" CodeFile="SarView6.aspx.cs"
    Inherits="SarView6" %>
                    ...
                    <a id="spnSvHead" onclick="SarView2('<%#Eval("SideCode")%>');">
                        <%#Eval("SideName")%></a>&nbsp;|&nbsp; <a id="spnSvHead" onclick="SarView3('<%#Eval("StandardCode")%>');">
                            <%#Eval("StandardName")%></a>&nbsp;|&nbsp; <a id="spnSvHead" onclick="SarView4('<%#Eval("IndicatorsCode")%>');">
                                <%#Eval("IndicatorsName")%></a>&nbsp;|&nbsp; <a id="spnSvHead" onclick="SarView5('<%#Eval("ProjectsCode")%>','<%#Eval("IndicatorsCode")%>');">
                                    <%#Eval("ProjectsName")%></a>&nbsp;|&nbsp; <span class="spnSvHeadAc">
