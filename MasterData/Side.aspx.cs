...
public partial class Side : System.Web.UI.Page
{
    ...
    {       
        if (!IsPostBack)
        {
            ...
            else
            {
                lblTitle1.Text = "ด้าน";
                lblTitle2.Text = "ด้าน";
                lblSideNo.Text = "ด้านที่";
                lblSide.Text = "ด้าน";
                GridView1.Columns[0].HeaderText = "ด้านที่";
                GridView1.Columns[1].HeaderText = "ชื่อด้าน";
                GridView2.Columns[0].HeaderText = "ด้านที่";
                GridView2.Columns[1].HeaderText = "ชื่อด้าน";
                btAdd.Text = "       สร้างด้านใหม่";
                btAdd.ToolTip = "สร้างด้านใหม่";
                btSave.ToolTip = "บันทึกด้านนี้";
                btSaveAgain.Text = "       บันทึกและสร้างด้านใหม่";
                btSaveAgain.ToolTip = "บันทึกด้านนี้และสร้างด้านใหม่";
            }            
    ...
    public override void DataBind()
    {
        ...
        if (txtSearch.Text != "")
        {
            StrSql = StrSql + " And (a.SideName Like '%" + txtSearch.Text + "%' Or a.Sort Like '%" + txtSearch.Text + "%')  ";
        }
