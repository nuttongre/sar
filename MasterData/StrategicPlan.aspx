...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "StrategicPlan.aspx?mode=3&id=" + id;
        }
        function Cancel() {
                    ...
                    <asp:View ID="view" runat="server">
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหากลยุทธ์ระดับแผนงาน</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างกลยุทธ์ระดับแผนงานใหม่" ToolTip="สร้างกลยุทธ์ระดับแผนงานใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server" PageSize="20">
                                <Columns>
                                    <Control:BoundField HeaderText="กลยุทธ์ที่" DataField="Sort">
                        ...
                        <div id="table1" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    ...
                                    <span id="ErrorSort" class="ErrorMsg">กรุณาป้อนกลยุทธ์ที่</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ชื่อกลยุทธ์ : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtStrategicPlan" CssClass="txtBoxL txt400" MaxLength="200" runat="server"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorStrategicPlan" class="ErrorMsg">กรุณาป้อนชื่อกลยุทธ์</span>
                                </div>
                            </div>
                             <div class="inputrowH">
                                <div class="divF_Head">
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridView2" runat="server" Visible="false" PageSize="20">
                                    <Columns>
                                        ...
                                        <Control:BoundField HeaderText="ชื่อกลยุทธ์" DataField="StrategicPlanName">
