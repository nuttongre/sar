...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function deleteItem(id) {
            if (confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "WorldClassSide.aspx?mode=3&id=" + id;
        }
        function Cancel() {
                ...
                <asp:MultiView ID="MultiView1" runat="server">
                    <asp:View ID="view" runat="server">
                        <div id="Div1" class="TableSearch">
                            <div class="SearchTable">
                                <div class="SearchHead">
                                    <span class="spantxt2 spansize14">ค้นหาด้านมาตรฐานสากล</span>
                                </div>
                                <div class="spaceDiv"></div>
                                <div class="inputrow">
                                ...
                                <div class="inputrow">
                                    <div class="SearchtxtF">
                                        <span id="Span1" runat="server" class="spantxt">หมวด : </span>
                                    </div>
                                    <div class="SearchF">
                            ...
                            <div class="btAddDiv">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();"
                                    Text="       สร้างด้านมาตรฐานสากลใหม่" ToolTip="สร้างด้านมาตรฐานสากลใหม่" />
                            </div>
                            <div class="spaceDiv"></div>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="gridViewDiv">
                            <Control:DataGridView ID="GridView1" runat="server">
                                <Columns>
                                    <Control:BoundField HeaderText="ด้านมาตรฐานสากลที่" DataField="Sort">
                                        <ItemStyle Width="10%" HorizontalAlign="Center" />
                                    </Control:BoundField>
                                    <Control:TemplateField HeaderText="ชื่อด้านมาตรฐานสากล">
                                        <ItemTemplate>
                    ...
                    <asp:View ID="edit" runat="server">
                        <div id="table1" class="PageManageDiv">
                            ...
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">หมวด : </span>
                                </div>
                                <div class="divB_Head">
                                    <asp:DropDownList CssClass="ddl" ID="ddlType" runat="server" AutoPostBack="true" Width="400"
                                        OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <span id="ErrorType" class="ErrorMsg">กรุณาเลือกหมวด</span>
                                </div>
                            </div>
                            <div class="inputrowH">
                                <div class="divF_Head">
                                    <span class="spantxt">ด้านมาตรฐานสากลที่ : </span>
                                </div>
                                <div class="divB_Head">
                            ...
                            <div class="inputrowH">
                                ...
                                <div class="divB_Head">
                                    <asp:TextBox ID="txtWorldClassSide" CssClass="txtBoxL txt400" MaxLength="200" runat="server"></asp:TextBox>&nbsp;<span
                                        class="ColorRed">*</span> <span id="ErrorWorldClassSide" class="ErrorMsg">กรุณาป้อนด้านมาตรฐานสากล</span>
                                </div>
                            </div>
                             <div class="inputrowH">
                                <div class="divF_Head">
                            ...
                            <div class="inputrowH" style="display:none;">
                                ...
                                <div class="divB_Head">
                                    ...
                                    </asp:DropDownList>--%>&nbsp;<span class="ColorRed">*</span> <span id="ErrorScore" class="ErrorMsg">กรุณาป้อนคะแนน</span>
                                </div>
                            </div>
                            <div class="spaceDiv"></div>
                            <%--<div class="gridViewDiv">
                                ...
                                <div class="classButton">
                                    <div class="classBtSave">
                                        <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก" OnClick="btSave_Click"
                                            OnClientClick="return Cktxt(1);" ToolTip="บันทึกด้านมาตรฐานสากลนี้" />
                                        <asp:Button ID="btSaveAgain" CssClass="btYesToo" runat="server" Text="       บันทึกและสร้างด้านมาตรฐานสากลใหม่"
                                            OnClick="btSaveAgain_Click" OnClientClick="return Cktxt(1);" ToolTip="บันทึกด้านมาตรฐานสากลนี้และสร้างด้านมาตรฐานสากลใหม่" />
                                    </div>
                            ...
                            <div class="gridViewDiv">
                                <Control:DataGridView ID="GridView2" runat="server" Visible="false">
                                    <Columns>
                                        ...
                                        <Control:BoundField HeaderText="ชื่อด้านมาตรฐานสากล" DataField="WorldClassSideName">
