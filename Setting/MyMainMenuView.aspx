...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    {
       if(confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "MyMainMenuView.aspx?mode=3&id=" + id;
    }
    function AddItem()
    {
            ...
            <tr>
                <td colspan="2" style="width: 100%">
                    <table id="TableSearch" runat="server" width="100%">
                                ...
                                <table class="tableSearch">
                                    <tr>
                                        <td colspan="3" class="headSearch">
                                            <span class="spantxt2 spansize14">ค้นหาเมนูหลัก</span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td class="SearchB">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" OnClientClick="AddItem();" Text="       เพิ่มเมนูหลักใหม่"
                                    OnClick="btAdd_Click" ToolTip="เพิ่มเมนูหลักใหม่" />
                            </td>
                            <td class="SearchtxtF">
                            </td>
                            <td class="SearchF">
                    ...
                    <table id="table1" runat="server" style="width: 100%;">
                        <tr>
                            <td align="right" style="width: 20%">
                                <span class="spantxt">ชื่อเมนูหลัก : </span>
                            </td>
                            <td>
                                <asp:TextBox CssClass="txtBoxL" ID="txtMyMainMenuName" runat="server" Width="300"></asp:TextBox>
                                <span id="ErrorMyMainMenuName" class="ErrorMsg">กรุณาป้อนชื่อเมนูหลัก</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 20%">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 80%">
                                <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก"
                                    OnClick="btSave_Click " OnClientClick="return Cktxt();" ToolTip="บันทึกเมนูหลักนี้" />
                                <asp:Button ID="btCancel" CssClass="btNo" runat="server" Text="       ไม่บันทึก"
                                    OnClick="btCancel_Click" ToolTip="ไม่บันทึกเมนูหลักนี้" />
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="2" style="text-align: center; width: 100%;">
                    <Control:DataGridView ID="GridView1" runat="server">
                        <Columns>
                            ...
                            <Control:BoundField DataField="MyMainMenuName" HeaderText="ชื่อเมนูหลัก">
