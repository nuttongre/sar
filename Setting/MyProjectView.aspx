...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    {
       if(confirm('ต้องการลบรายการนี้ ใช่หรือไม่')) location.href = "MyProjectView.aspx?mode=3&id=" + id;
    }
    function AddItem()
    {
            ...
            <tr>
                <td colspan="2" style="width: 100%">
                    <table id="TableSearch" runat="server" width="100%">
                                ...
                                <table class="tableSearch">
                                    <tr>
                                        <td colspan="3" class="headSearch">
                                            <span class="spantxt2 spansize14">ค้นหาระบบงาน</span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <tr>
                            <td class="SearchB">
                                <asp:Button ID="btAdd" CssClass="btAdd" runat="server" Text="       เพิ่มระบบงานใหม่"
                                    OnClientClick="AddItem();" OnClick="btAdd_Click" ToolTip="เพิ่มระบบงานใหม่" />
                            </td>
                            <td class="SearchtxtF">
                            </td>
                            <td class="SearchF">
                    ...
                    <table id="table1" runat="server" style="width: 100%;">
                        <tr>
                            <td align="right" style="width: 20%">
                                <span class="spantxt">ชื่อระบบงาน : </span>
                            </td>
                            <td>
                                <asp:TextBox CssClass="txtBoxL" ID="txtMyProjectName" runat="server" Width="300px"></asp:TextBox>
                                <span id="ErrorMyProjectName" class="ErrorMsg">กรุณาป้อนชื่อระบบงาน</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 20%">
                                <span class="spantxt">หน้าเริ่มต้น : </span>
                            </td>
                            <td>
                                <asp:TextBox CssClass="txtBoxL" ID="txtStartPage" runat="server" Width="300px"></asp:TextBox>
                                <span id="ErrorStartPage" class="ErrorMsg">กรุณาป้อนหน้าเริ่มต้น</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 20%">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 80%">
                                <asp:Button ID="btSave" CssClass="btYes" runat="server" Text="       บันทึก"
                                    OnClick="btSave_Click " OnClientClick="return Cktxt();" ToolTip="บันทึกระบบงานนี้" />
                                <asp:Button ID="btCancel" CssClass="btNo" runat="server" Text="       ไม่บันทึก"
                                    OnClick="btCancel_Click" ToolTip="ไม่บันทึกระบบงานนี้" />
                            </td>
                        </tr>
                    </table>
                </td>
                ...
                <td colspan="2" style="text-align: center; width: 100%;">
                    <Control:DataGridView ID="GridView1" runat="server">
                        <Columns>
                            ...
                            <Control:BoundField DataField="MyProjectName" HeaderText="ชื่อระบบงาน">
